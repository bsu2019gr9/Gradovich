...
void task1(int n, int* dest) {
	mkArrOfInt(n, dest);
	initRandomArray(dest, dest + n, -10, 10);
	printArray(dest, dest + n);
	countRepeatingElements(dest, dest + n);
}

void task2(int n, int* dest) {
	mkArrOfInt(n, dest);
	initRandomArray(dest, dest + n, -10, 20);
	printArray(dest, dest + n);
	countRepeatingInARow(dest, dest + n);
}
